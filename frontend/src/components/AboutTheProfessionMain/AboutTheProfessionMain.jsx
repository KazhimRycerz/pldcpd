...
const AboutTheProfessionMain = () => {
  ...
  const handleScroll = (e, targetId) => {
    e.preventDefault(); // Standard-Scroll-Verhalten verhindern
  
    const element = document.querySelector(targetId);
    if (element) {
      const offset = 200; // Abstand in Pixeln
  ...
  const sliderSettings = {
    dots: true, // Anzeigen von Punkten für den Slider
    infinite: true,
    speed: 500,
    slidesToShow: 1,
    slidesToScroll: 1,
  ...
  const goToLevel = (levelIndex) => {
    carouselRef.current.goTo(levelIndex);
  };
  ...
  return (
    <>
      <main id="professionMain"> {/* Styling in global */}
  
        <section id="professionSectionOne">
          ...
          <div className="infobox_intro">
            ...
            <div id="careerLadder"> 
              <div onMouseLeave={closeDropdown}>
                ...
                <ul>
                  <li>
                    <a href="#levelI" onClick={(e) => handleScroll(e, "#levelI")}>Level I</a>
                  </li>
                  <li>
                    <a href="#levelII" onClick={(e) => handleScroll(e, "#levelII")}>Level II</a>
                  </li>
                  <li>
                    <a href="#levelIII" onClick={(e) => handleScroll(e, "#levelIII")}>Level III</a>
                  </li>
                  <li>
                    <a href="#levelIV" onClick={(e) => handleScroll(e, "#levelIV")}>Level IV</a>
                  </li>
                  <li>
                    <a href="#levelV" onClick={(e) => handleScroll(e, "#levelV")}>Level V</a>
                  </li>
                  <li>
                    <a href="#levelVI" onClick={(e) => handleScroll(e, "#levelVI")}>Level VI</a>
                  </li>
                  <li>
                    <a href="#levelVII" onClick={(e) => handleScroll(e, "#levelVII")}>Level VII</a>
                  </li>
                  <li>
                    <a href="#levelVIII" onClick={(e) => handleScroll(e, "#levelVIII")}>Level VIII</a>
                  </li>
                  <li>
                    <a href="#levelIX" onClick={(e) => handleScroll(e, "#levelIX")}>Level IX</a>
                  </li>
                </ul>
                )}
                </h3>
        ...
        <section id="professionalLevelKarussel">
          <h2> Lichtdesigner - Wissen und Themen auf der Karriereleiter </h2>
          <div id="slider-container">
            <Carousel {...sliderSettings}>
              <div id="levelI">
                ...
                <div>
                  <ul>Knowledge you need to cover...
                    <li className="pFunction"> Latest technical lighting knowledge</li>
                    <li className="pFunction"> Latest lighting design techniques/skills</li>
                    <li className="pFunction"> Theoretical and practical know-how on the creative arts</li>
                    <li className="pFunction"> Practical experience in (architectural) lighting design </li>
                    <li className="pFunction"> Visual and verbal communication</li>
                  </ul>
                  <img src={require('../../images/Level_1_SLD.jpg')} alt="" />
                </div>
              </div>
              <div id="levelII">
                <h3> Level II - Newly qualified lighting designer <br /></h3>
                <h4>(1 year minimum of qualifying employment)</h4>
                <div>
                  <ul>Knowledge you need to cover...
                    <li className="pFunction"> Latest technical lighting knowledge</li>
                    <li className="pFunction"> Latest lighting design techniques/skills</li>
                    <li className="pFunction"> Presentation techniques to colleagues/clients</li>
                    <li className="pFunction"> Lighting calculations </li>
                    <li className="pFunction"> Multidisciplinary teamwork</li>
                    <li className="pFunction"> Expression of views/opinions</li>
                    <li className="pFunction"> Observation and evaluation of architectural space</li>
                  </ul>
                  <img src={require('../../images/Level_2_NQLD.jpg')} alt="" />
                </div>
              </div>
            ...
            <div className="level-links">
              <ul>
                <li><Button className="pFunction" type="link" onClick={() => goToLevel(0)}>level I</Button><p className="invisibleP">Student lighting designer</p></li>
                <li><Button className="pFunction" type="link" onClick={() => goToLevel(1)}>level II</Button><p className="invisibleP">Newly qualified lighting designer</p></li>
                <li><Button className="pFunction" type="link" onClick={() => goToLevel(2)}>level III</Button><p className="invisibleP">Junior lighting designer</p></li>
                <li><Button className="pFunction" type="link" onClick={() => goToLevel(3)}>level IV</Button><p className="invisibleP">Project lighting designer</p></li>
                <li><Button className="pFunction" type="link" onClick={() => goToLevel(4)}>level V</Button><p className="invisibleP">Senior lighting designer</p></li>
                <li><Button className="pFunction" type="link" onClick={() => goToLevel(5)}>level VI</Button><p className="invisibleP">Associate lighting designer</p></li>
                <li><Button className="pFunction" type="link" onClick={() => goToLevel(6)}>level VII</Button><p className="invisibleP">Principle lighting designer</p></li>
                <li><Button className="pFunction" type="link" onClick={() => goToLevel(7)}>level VIII</Button><p className="invisibleP">Master lighting designer</p></li>
                <li><Button className="pFunction"type="link" onClick={() => goToLevel(8)}>level IX</Button><p className="invisibleP">Authorised expert in lighting design</p></li>
              </ul>
            </div>
          </div>
        </section>
